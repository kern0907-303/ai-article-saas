...
MODEL_CATALOG: list[ModelCatalogItem] = [
    ModelCatalogItem(
        ...
        category="text",
        label="GPT-5.4 Mini",
        description="近前沿品質與較低成本，適合日常文章生成",
        cost_tier="low",
    ),
    ModelCatalogItem(
        key="gpt-5.4",
    ...
    ModelCatalogItem(
        ...
        category="text",
        label="GPT-5.5",
        description="OpenAI 最新高能力模型，適合最重要的專業內容",
        cost_tier="high",
    ),
    ModelCatalogItem(
        key="gpt-5.5-pro",
        ...
        category="text",
        label="GPT-5.5 Pro",
        description="更高精度輸出，適合高價值長文與策略稿",
        cost_tier="high",
    ),
    ModelCatalogItem(
        key="gpt-5.4-nano",
        ...
        category="text",
        label="GPT-5.4 Nano",
        description="最低成本快速模型，適合大量提示詞擴寫",
        cost_tier="low",
    ),
    ModelCatalogItem(
        ...
        description="Anthropic 快速低成本模型，適合提示詞與短文草稿",
        cost_tier="low",
    ),
    ModelCatalogItem(
        ...
        description="速度與智慧平衡，適合大多數長文工作流",
        cost_tier="medium",
    ),
    ModelCatalogItem(
        key="claude-opus-4-8",
        ...
        description="Anthropic 高能力模型，適合複雜推理與深度內容",
        cost_tier="high",
    ),
    ModelCatalogItem(
        ...
        description="Google 穩定高效模型，適合高吞吐內容工作",
        cost_tier="low",
    ),
    ModelCatalogItem(
        key="gemini-3.1-pro",
    ...
    ModelCatalogItem(
        ...
        description="低延遲低成本模型，適合大量草稿與提示詞任務",
        cost_tier="low",
    ),
    ModelCatalogItem(
    ...
    ModelCatalogItem(
        ...
        provider="github",
        category="text",
        label="GitHub Models: GPT-5.4 Mini",
        description="透過 GitHub Models 使用 OpenAI 的新一代快速模型",
        cost_tier="low",
    ),
    ModelCatalogItem(
        key="openai/gpt-5.5",
        provider="github",
        category="text",
        label="GitHub Models: GPT-5.5",
        description="透過 GitHub Models 使用 OpenAI 高能力模型",
        cost_tier="high",
    ),
    ModelCatalogItem(
        key="openai/gpt-5.4",
    ...
    ModelCatalogItem(
        ...
        provider="github",
        category="text",
        label="GitHub Models: Claude Sonnet 4.6",
    ...
    ModelCatalogItem(
        ...
        provider="github",
        category="text",
        label="GitHub Models: Gemini 3.5 Flash",
    ...
    ModelCatalogItem(
        ...
        category="image",
        label="Nano Banana 2",
        description="高效率圖片生成與編輯，適合大量社群素材",
        cost_tier="medium",
    ),
]
